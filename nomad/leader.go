...
func (s *Server) revokeLeadership() error {
	...
	// Disable the eval broker, since it is only useful as a leader. We do not
	// need to check the scheduler configuration paused eval broker value, as
	// the broker should always be paused on the non-leader.
	//
